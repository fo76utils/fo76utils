...
* **Mouse L button**: In debug mode 1 only: print the geometry block, mesh and material path of the selected shape based on the color of the pixel, and also copy it to the clipboard.
* **H**: Show help screen.
* **C**: Clear messages.
* **Esc**: Quit program.
